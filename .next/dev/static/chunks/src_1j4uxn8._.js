...
function Navbar() {
    ...
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("header", {
        ...
        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
            className: `container ${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$layout$2f$Navbar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].navbar}`,
            children: [
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$client$2f$app$2d$dir$2f$link$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"], {
                    href: "/contact-us",
                    className: `theme-btn ${__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$components$2f$layout$2f$Navbar$2e$module$2e$css__$5b$app$2d$client$5d$__$28$css__module$29$__["default"].cta}`,
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            children: "↗"
                        }, void 0, false, {
...
"[project]/src/components/animations/TemplateMotion.tsx [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
            ...
            const ctx = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].context({
                "TemplateMotion.useEffect.ctx": ()=>{
                    ...
                    document.querySelectorAll("[data-split]").forEach({
                        "TemplateMotion.useEffect.ctx": (heading)=>{
                            const split = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$split$2d$type$2f$dist$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"](heading, {
                            ...
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].to(split.chars, {
                                scrollTrigger: {
                                    trigger: heading,
                                    start: "top 90%",
                                    once: true
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].utils.toArray("[data-animate='fade-up'], .elementor-invisible").forEach({
                        "TemplateMotion.useEffect.ctx": (item)=>{
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].to("[data-hero-bg]", {
                        scale: 1.08,
                        duration: 12,
                        ease: "power1.out"
                    });
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].utils.toArray("[data-counter]").forEach({
                        "TemplateMotion.useEffect.ctx": (counter)=>{
                            ...
                            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].fromTo(counter, {
                                ...
                                onUpdate: {
                                    "TemplateMotion.useEffect.ctx": function() {
                    ...
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].utils.toArray("[data-hover-lift]").forEach({
                        "TemplateMotion.useEffect.ctx": (item)=>{
                            const enter = {
                                "TemplateMotion.useEffect.ctx.enter": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].to(item, {
                                        y: -8,
                                        scale: 1.03,
                                        duration: 0.3,
                                        ease: "power2.out"
                                    })
                            }["TemplateMotion.useEffect.ctx.enter"];
                            const leave = {
                                "TemplateMotion.useEffect.ctx.leave": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].to(item, {
                                        y: 0,
                                        scale: 1,
                                        duration: 0.3,
                                        ease: "power2.out"
                                    })
                            }["TemplateMotion.useEffect.ctx.leave"];
                    ...
                    if (cursor && cursorBall && window.innerWidth > 1024) {
                        const move = {
                            "TemplateMotion.useEffect.ctx.move": (event)=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].to(cursor, {
                                    x: event.clientX,
                                    y: event.clientY,
                                    duration: 0.15,
                                    ease: "power2.out"
                                })
                        }["TemplateMotion.useEffect.ctx.move"];
                        window.addEventListener("mousemove", move);
                        cleanupFns.push({
                            "TemplateMotion.useEffect.ctx": ()=>window.removeEventListener("mousemove", move)
                        }["TemplateMotion.useEffect.ctx"]);
                        document.querySelectorAll("a, button").forEach({
                            "TemplateMotion.useEffect.ctx": (item)=>{
                                const enter = {
                                    "TemplateMotion.useEffect.ctx.enter": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].to(cursorBall, {
                                            scale: 2.4,
                                            opacity: 0.35,
                                            duration: 0.25
                                        })
                                ...
                                const leave = {
                                    "TemplateMotion.useEffect.ctx.leave": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["default"].to(cursorBall, {
                                            scale: 1,
                                            opacity: 1,
                                            duration: 0.25
                                        })
                    ...
                    window.setTimeout({
                        "TemplateMotion.useEffect.ctx": ()=>__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$ScrollTrigger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScrollTrigger"].refresh()
                    }["TemplateMotion.useEffect.ctx"], 300);
                }
            }["TemplateMotion.useEffect.ctx"]);
            return ({
                "TemplateMotion.useEffect": ()=>{
                    cleanupFns.forEach({
                        "TemplateMotion.useEffect": (cleanup)=>cleanup()
                    }["TemplateMotion.useEffect"]);
                    ctx.revert();
                    splitInstances.forEach({
                        "TemplateMotion.useEffect": (split)=>split.revert()
                    }["TemplateMotion.useEffect"]);
                    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$gsap$2f$ScrollTrigger$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ScrollTrigger"].getAll().forEach({
                        "TemplateMotion.useEffect": (trigger)=>trigger.kill()
                    }["TemplateMotion.useEffect"]);
                }
            })["TemplateMotion.useEffect"];
        }
...
_s(TemplateMotion, "OD7bBpZva5O2jO+Puf00hKivP7c=");
_c = TemplateMotion;
var _c;
__turbopack_context__.k.register(_c, "TemplateMotion");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
//# sourceMappingURL=src_1j4uxn8._.js.map